...
export const privacyPolicyCopy: Record<PrivacyLocale, PrivacyPageCopy> = {
  ko: {
    pageTitle: "개인정보 처리방침",
    ...
    automatic: {
      ...
      intro:
        "{appName} 자체는 웹 쿠키를 설치하지 않습니다. 다만 내장 YouTube 플레이어, Firebase와 Google 광고 서비스는 쿠키 또는 유사 기술, 광고 ID, 앱 인스턴스·기기·이용 정보를 처리할 수 있습니다.",
      items: [
  ...
  en: {
    ...
    automatic: {
      ...
      intro:
        "{appName} does not itself install web cookies. The embedded YouTube player, Firebase, and Google advertising services may process cookies or similar technologies, advertising IDs, and app instance, device, and usage information.",
      items: [
  ...
  ja: {
    ...
    automatic: {
      ...
      intro:
        "{appName}自体はウェブCookieを設置しません。ただし、埋め込みYouTubeプレーヤー、Firebase、Google広告サービスは、Cookieまたは類似技術、広告ID、アプリインスタンス・端末・利用情報を処理する場合があります。",
      items: [
